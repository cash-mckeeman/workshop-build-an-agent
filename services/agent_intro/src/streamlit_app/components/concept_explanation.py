...
def render_concept_card(
    title: str, description: str, examples: list[str] = None, icon: str = "📚"
):
...
def show_agent_component_overview():
    ...
    for component in components:
        render_concept_card(
            component["title"], component["description"], component["examples"]
        )
...
def show_component_interaction():
    ...
    st.success(
        "🎉 **Result:** The agent successfully answered the question using all four components!"
    )
...
def show_tutorial_roadmap():
    ...
    pages = [
        ...
        {"name": "Tools", "icon": "🛠️", "description": "Learn to create and use tools"},
        {
            "name": "Memory",
            "icon": "💾",
            "description": "Understand conversation memory",
        },
        {
            "name": "Routing",
            "icon": "🚦",
        ...
        },
        {
            "name": "Complete Agent",
            "icon": "🤖",
            "description": "Build a full-featured agent",
        },
    ]
    ...
    st.info(
        "💡 Each page builds on the previous one. Complete them in order for the best learning experience!"
    )
