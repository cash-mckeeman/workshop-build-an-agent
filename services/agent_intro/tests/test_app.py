...
class TestTutorialSection:
    ...
    def test_tutorial_section_content(
        self, mock_subheader, mock_columns, mock_markdown, mock_header
    ):
...
class TestPlaygroundSection:
    ...
    @patch("app.get_recommended_setup")
    def test_playground_section_not_ready(
        self, mock_get_setup, mock_error, mock_header
    ):
        ...
        mock_error.assert_called_once_with(
            "Please configure a provider first (see sidebar)"
        )
    ...
    @patch("app.get_recommended_setup")
    def test_playground_section_ready(
        self,
        mock_get_setup,
        mock_session_state,
        mock_button,
    ...
    def test_playground_section_with_message(
        self,
        mock_create_agent,
        mock_get_setup,
        mock_session_state,
...
class TestMathDemoSection:
    ...
    @patch("streamlit.button")
    @patch("app.get_recommended_setup")
    def test_math_demo_section_ready(
        self,
        mock_get_setup,
        mock_button,
        mock_code,
    ...
    @patch("app.get_recommended_setup")
    @patch("app.create_tutorial_agent")
    def test_math_demo_basic_agent_button(
        self,
        mock_create_agent,
        mock_get_setup,
        mock_warning,
...
class TestToolsDemoSection:
    ...
    @patch("streamlit.error")
    @patch("app.get_recommended_setup")
    def test_tools_demo_section_not_ready(
        self, mock_get_setup, mock_error, mock_header
    ):
    ...
    @patch("app.get_recommended_setup")
    def test_tools_demo_section_ready(
        self,
        mock_get_setup,
        mock_text_input,
        mock_button,
    ...
    @patch("app.get_recommended_setup")
    @patch("app.create_tutorial_agent")
    def test_tools_demo_button_click(
        self,
        mock_create_agent,
        mock_get_setup,
        mock_success,
    ...
    @patch("app.get_recommended_setup")
    @patch("app.create_tutorial_agent")
    def test_tools_demo_custom_question(
        self,
        mock_create_agent,
        mock_get_setup,
        mock_success,
...
class TestSidebarFunctionality:
    ...
    @patch("streamlit.button")
    @patch("app.get_recommended_setup")
    def test_main_sidebar_ready_provider(
        self,
        mock_get_setup,
        mock_button,
        mock_radio,
    ...
    @patch("streamlit.button")
    @patch("app.get_recommended_setup")
    def test_main_sidebar_not_ready_provider(
        self,
        mock_get_setup,
        mock_button,
        mock_radio,
        ...
        mock_warning.assert_called_once_with(
            "Please configure API keys or start Ollama"
        )
    ...
    def test_main_sidebar_health_check(
        self,
        mock_check_providers,
        mock_get_setup,
        mock_subheader,
        mock_spinner,
        mock_button,
        ...
        mock_results = {
            ...
            "anthropic": HealthCheckResult(
                "anthropic", HealthStatus.UNHEALTHY, "Failed"
            ),
        }
...
class TestErrorHandling:
    ...
    @patch("app.get_recommended_setup")
    @patch("app.create_tutorial_agent")
    def test_math_demo_error_handling(
        self,
        mock_create_agent,
        mock_get_setup,
        mock_error,
    ...
    @patch("app.get_recommended_setup")
    @patch("app.create_tutorial_agent")
    def test_tools_demo_error_handling(
        self,
        mock_create_agent,
        mock_get_setup,
        mock_error,
