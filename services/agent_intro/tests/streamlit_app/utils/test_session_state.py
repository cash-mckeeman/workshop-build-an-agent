...
class TestInitializeSessionState:
    ...
    def test_initialize_session_state_fresh(self, mock_session_state):
        ...
        assert hasattr(mock_session_state, 'messages') or mock_session_state.__setattr__.called
...
class TestMessageManagement:
    ...
    def test_add_multiple_messages(self, mock_session_state):
        ...
        assert mock_session_state.messages[1] == {"role": "assistant", "content": "Hi there!"}
        assert mock_session_state.messages[2] == {"role": "user", "content": "How are you?"}
...
class TestSessionStateIntegration:
    ...
    def test_tutorial_completion_tracking(self, mock_session_state):
        ...
        tutorial_pages = ["welcome", "model_setup", "tools", "memory", "routing", "complete_agent"]
